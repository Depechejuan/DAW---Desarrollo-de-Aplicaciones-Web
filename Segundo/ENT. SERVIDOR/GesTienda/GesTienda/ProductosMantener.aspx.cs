            ...
            using (SqlConnection conexion = new SqlConnection(StrCadenaConexion))
            {
                try
                {
                    ...
                    if (inRegistrosAfectados == 1)
                        ...
                        lblMensajes.Text = "No se actualizó el registro (puede que no exista).";
            ...
            using (SqlConnection conexion = new SqlConnection(StrCadenaConexion))
            {
                try
                {
                    ...
                    if (inRegistrosAfectados == 1)
                        ...
                        lblMensajes.Text = "No se eliminó ningún registro (puede que no exista).";
                    ...
                    txtDesPro.Text = "";
                    txtPrePro.Text = "0";
                    ddlIdUnidad.ClearSelection();
                    ddlIdTipo.ClearSelection();
                }
                catch (SqlException ex)
                {
                    string StrError = "<p>Se han producido errores en el acceso a la base de datos.</p>";
