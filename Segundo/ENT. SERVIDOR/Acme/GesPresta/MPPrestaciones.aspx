<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="MPPrestaciones.aspx.cs" Inherits="GesPresta.MPPrestaciones" %>
    ...
    <div class="forms">
        ...
        <div class="row">
            ...
            <div class="input">
                ...
                <asp:Button ID="btnVerPrestaciones" runat="server" Text="Ver Prestaciones"
                    CausesValidation="False" OnClick="btnVerPrestaciones_Click" />
                <asp:RequiredFieldValidator ID="rqdtxtCodPre" runat="server" ControlToValidate="txtCodPre"
                    ErrorMessage="El Código Empleado es obligatorio" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="regtxtCodPre" runat="server" ControlToValidate="txtCodPre"
                    ErrorMessage="El formato debe ser: 000-000-000" ForeColor="Green"
            ...
            <div style="margin: 0 40px">
                <asp:Button ID="btnSeleccionar" runat="server" CausesValidation="False" Text="Seleccionar"
                    Visible="False" OnClick="btnSeleccionar_Click" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input">
                ...
                <asp:RangeValidator ID="rngtxtImpPre" runat="server" ControlToValidate="txtImpPre"
                    ErrorMessage="El importe debe estar entre 0 y 500" ForeColor="#CC3300"
                    MaximumValue="500,00" MinimumValue="0,00" Type="Double"></asp:RangeValidator>
                <asp:RequiredFieldValidator ID="rqdtxtImpPre" runat="server" ControlToValidate="txtImpPre"
                    ErrorMessage="El importe fijo es obligatorio" ForeColor="#CC3300"></asp:RequiredFieldValidator>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input">
                ...
                <asp:RangeValidator ID="rngtxtPorPre" runat="server" ControlToValidate="txtPorPre"
                    ErrorMessage="El porcentaje debe estar entre 0 y 15" ForeColor="#CC3300"
                    MaximumValue="15,00" MinimumValue="0,00" Type="Double"></asp:RangeValidator>
                <asp:RequiredFieldValidator ID="rqdtxtPorPre" runat="server" ControlToValidate="txtPorPre"
                    ErrorMessage="El porcentaje del informe es obligatorio" ForeColor="#CC3300"></asp:RequiredFieldValidator>
            </div>
        </div>
        ...
        <asp:Button ID="cmdEnviar" runat="server" Text="Enviar"
            PostBackUrl="~/Prestaciones1Respuesta.aspx"
            OnClick="Page_Load" Width="132px" />
